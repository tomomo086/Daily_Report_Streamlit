...
- **天気・勤務区分管理**: 天気情報と勤務区分（通常/早出/残業）の自動処理
- **Excelファイル編集機能**: 既存日報のアップロード・編集・再出力機能
...
│   └── cell_definitions.py # セル定義管理（AI実装）
